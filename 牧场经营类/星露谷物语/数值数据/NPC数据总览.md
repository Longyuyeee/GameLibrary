...
| 名册字段完整率 | 46 / 46，100% |
| NPC 数据域状态 | **采集中**：名册与礼物偏好子域完成；日程、事件和关系数值子域尚未验收 |
...
| 关系数值 | `NPC关系数值总览.md` | 待采集 | 好感增减、衰减、送礼倍率、恋爱、婚姻、室友、离婚及记忆消除 |

机制解读见 [NPC社交系统](../机制分析/NPC社交系统.md)。未创建的三个数据文档不会计入已完成文档数；创建后必须先完成全集与字段对账。
