...
def render_document() -> str:
    ...
    lines = [
        ...
        "| 唯一归属 | 本文是技能经验、升级解锁、职业与精通的唯一数据源；通用生命/精力、角色状态和战斗公式留在[角色属性战斗数据总览](./角色属性战斗数据总览.md)；非配方特殊消耗品、工具、钓具、武器、护甲、戒指、饰品、服装、锻造与附魔留在[道具装备数据总览](./道具装备数据总览.md)；怪物击杀对象与掉落见[怪物数据总览](./怪物数据总览.md) |",
